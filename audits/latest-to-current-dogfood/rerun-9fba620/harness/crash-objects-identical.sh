...
echo
echo "and the migrated checkpoint this audit carried forward:"
printf '%-22s %s  %s\n' checkpoints/migrated "$(oh checkpoints/migrated)" "$([ "$(oh checkpoints/migrated)" = "$base" ] && echo IDENTICAL || echo DIFFERENT)"
