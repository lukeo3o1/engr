...
$first = & "D:\lukeo3o1\engr-audit\t5.ps1" -Log $Log -Which current -WorkDir $WorkDir @EngrArgs | Out-String
...
& "D:\lukeo3o1\engr-audit\g5.ps1" -Log $Log -Which current -WorkDir $WorkDir @second
