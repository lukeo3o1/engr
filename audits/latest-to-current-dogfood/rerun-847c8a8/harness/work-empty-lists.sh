...
set -u
# r7 prepared this workspace by hand, so the probe depended on a step that was
# nowhere written down. It prepares its own now, from the migrated checkpoint.
rm -rf /audit/r8/wk
cp -a /audit/r8/checkpoints/migrated /audit/r8/wk
mkdir -p /audit/r8/wk/.engr/work/objects
cd /audit/r8/wk
