...
rm -rf /audit/r7/scratch/fresh && mkdir -p /audit/r7/scratch/fresh && cd /audit/r7/scratch/fresh
...
diff .engr/.gitignore /audit/r7/scratch/fresh/.engr/.gitignore && echo "IDENTICAL"
echo "--- every migrated Event's admitted.at ---"
cat .engr/eventstore/objects/*.jsonl | sed -n 's/.*"admitted":{"at":"\([^"]*\)".*/\1/p'
echo "pre-confirm  wallclock: $(cat /audit/r7/evidence/pre-confirm-wallclock.txt)"
echo "post-confirm wallclock: $(cat /audit/r7/evidence/post-confirm-wallclock.txt)"
