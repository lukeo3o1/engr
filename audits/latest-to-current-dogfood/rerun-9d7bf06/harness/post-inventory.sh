...
sh harness/inventory.sh . > /audit/r7/evidence/inventory-post-migration.txt
echo "--- migrated inventory (this run) ---"
cat /audit/r7/evidence/inventory-post-migration.txt
...
echo "--- checkpoint it ---"
rm -rf /audit/r7/checkpoints/migrated
