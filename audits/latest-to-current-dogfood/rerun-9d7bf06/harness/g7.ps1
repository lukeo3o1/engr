# r7 gate: prepare, read the code off the rendered screen, confirm.
param(
...
$screen = & "D:\lukeo3o1\engr-audit\t7.ps1" -Log $Log -Which $Which -WorkDir $WorkDir @EngrArgs | Out-String
...
$code = $Matches[1]
& "D:\lukeo3o1\engr-audit\t7.ps1" -Log $Log -Which $Which -WorkDir $WorkDir -- confirm "CONFIRM $code"
