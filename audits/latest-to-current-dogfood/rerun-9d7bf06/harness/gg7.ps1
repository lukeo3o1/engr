...
$first = & "D:\lukeo3o1\engr-audit\t7.ps1" -Log $Log -Which current -WorkDir $WorkDir @EngrArgs | Out-String
...
& "D:\lukeo3o1\engr-audit\g7.ps1" -Log $Log -Which current -WorkDir $WorkDir @second
